<div x-data="{ openSidebar: false }" class="relative">
    ...
    <div class="md:hidden px-4 py-3 bg-blue-100">
        <button @click="openSidebar = !openSidebar"
            class="p-2 text-gray-700 rounded-sm hover:bg-blue-200 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400">
    ...
    <aside :class="{ '-translate-x-full': !openSidebar }"
        ...
        <!-- Sidebar Inner -->
        <div class="flex flex-col p-4 px-6 py-6 overflow-y-auto bg-white rtl:border-r-1 rtl:border-l">
            <!-- Menu -->
            <nav class="relative">
                <!-- Dashboard Link -->
                ...
                <div>
                    <x-nav-link :href="route('produk.index')" :active="request()->routeIs('/admin/produk')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            <path
                    ...
                    <x-nav-link :href="route('kriteria.index')" :active="request()->routeIs('/admin/kriteria')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    ...
                    <x-nav-link :href="route('alternatif.index')" :active="request()->routeIs('admin/alternatif')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            <path fill-rule="evenodd"
                    ...
                    <x-nav-link :href="route('hasil.index')" :active="request()->routeIs('admin/hasil')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            <path fill-rule="evenodd"
