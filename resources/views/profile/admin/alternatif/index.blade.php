<x-app-layout title="Penilaian Alternatif">
    {{-- Header --}}
    <x-slot name="header">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gradient-to-tr from-fuchsia-500 to-pink-500">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="py-3.5 px-6 text-sm font-semibold uppercase text-left rtl:text-right text-neutral-50">
                                            <div class="flex items-center gap-x-3">
                                                <span>Penjualan</span>
                                            </div>
                                        </th>
                                ...
                                <tbody class="bg-white divide-y divide-slate-200">
                                    <tr>
                                        ...
                                        <td class="px-16 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <h2 class="text-sm font-semibold capitalize text-gray-500">Rose Garden
                                            </h2>
                                        </td>
