<x-admin-layout title="Kriteria SPK">
    {{-- Header --}}
    <x-slot name="header">
    ...
    <div class="flex-1 px-2 sm:px-6 lg:px-12 overflow-y-auto">
        <div class="bg-white p-6 pr-8 rounded-lg shadow-sm">
            <div class="relative flex justify-between items-center mt-4 md:mt-0">
                <div>
                    <h1 class="text-lg sm:text-xl lg:text-xl font-bold">Kriteria Management</h1>
                    <p class="text-sm sm:text-sm lg:text-sm font-normal text-gray-500">View, add, and manage the
                        kriteria used for evaluating parfume products.</p>
                </div>
                        ...
                        <div class="overflow-hidden border border-gray-200 md:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gradient-to-tr from-red-500 to-orange-500">
                                    <tr>
                                        <th scope="col"
                                            class="py-3.5 px-14 text-sm font-semibold capitalize text-left rtl:text-right text-neutral-50">
                                        ...
                                        <th scope="col"
                                            class="py-3.5 px-12 text-sm font-semibold capitalize text-left rtl:text-right text-neutral-50">
                                            <div class="flex items-center gap-x-3">
                                                <span>Tipe Kriteria</span>
                                            </div>
                                        </th>
